...
int main(int argc, char** argv){
    ...
    while (true) {
        ...
        //create a smaller frame of one third the size of the original frame to reduce the size of the video. Fill it using the average of pixel colors of the original frame
    ...
    if (rank == root) {
        ...
        cv::VideoWriter videoWriter("output_video.mp4", cv::VideoWriter::fourcc('X', '2', '6', '4'), fps, cv::Size(1920/3, 1080/3));
